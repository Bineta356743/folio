 ...
 */
final class Version20240531094922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE experience (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, ids DATETIME NOT NULL, date_f DATETIME NOT NULL, nom_etablissement VARCHAR(255) NOT NULL, ville_etablissement VARCHAR(255) NOT NULL, nom_poste VARCHAR(255) NOT NULL, mission VARCHAR(255) NOT NULL, responsable TINYINT(1) NOT NULL, INDEX IDX_590C10312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
